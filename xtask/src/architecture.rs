...
const MODULE_POLICIES: &[ModulePolicy] = &[
    ...
    ModulePolicy {
        ...
        allowed_internal: &["payload_strategy", "planner", "rules"],
        allowed_external: &[],
    },
    ModulePolicy {
    ...
    ModulePolicy {
        ...
        allowed_internal: &["knowledge", "planner", "rules"],
        allowed_external: &[],
    },
    ModulePolicy {
    ...
    ModulePolicy {
        ...
        allowed_internal: &["api_observation", "knowledge"],
        allowed_external: &["sha2"],
    },
    ModulePolicy {
        source: "api_observation/ingest.rs",
        allowed_internal: &["api_observation", "knowledge", "rules"],
        allowed_external: &[],
    },
    ModulePolicy {
...
pub(crate) fn check(workspace_root: &Path) -> Result<(), Box<dyn Error>> {
    ...
    violations.extend(report_bundle::check(workspace_root)?);
